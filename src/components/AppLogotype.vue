<template>
  <!--
    SVG wordmark — Russo One bold-geometric display, gradient lapis→gold.
    The <h1> wrapper keeps heading semantics; shadows applied via CSS.
    Font is bundled at /fonts/russo-one-latin.woff2 for offline PWA use.
  -->
  <svg
    viewBox="0 0 540 92"
