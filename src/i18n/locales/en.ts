...
export default {
  ...
  taxi: {
    ...
    level: 'Level {level}',
    howTo:
      'Your passenger gives directions in Uzbek. Drag the taxi along the streets to where they mean, then tap it to let them out — turn where you were told, and pull up in the street they named. The fare is worth a word each plus its distance, and that is the purse: fuel and every word you tap to have translated come out of it, and you keep what is left when they step out. Spend the lot, or lose the passenger, and it costs one of your three fares.',
    start: 'Start the shift',
    takings: 'Takings',
    fare: 'Fare',
    best: 'Best',
    patience: 'The passenger will try {count} more corners',
    ...
    steer:
      'Drag to drive — {fuel} soʻm a block, out of the fare. Tap a word to translate it — {word} soʻm. Tap the taxi to drop off.',
    arrived: 'Rahmat!',
    notThere: 'Not here — they stay in the cab.',
    gaveUp: 'They gave up and got out.',
