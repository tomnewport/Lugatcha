...
export default {
  ...
  taxi: {
    ...
    level: 'Level {level}',
    howTo:
      'Your passenger gives directions in Uzbek. Drag the taxi along the streets to where they mean, then tap it to let them out — turn where you were told, and pull up in the street they named. The fare pays for its words and its distance; fuel and every word you tap to have translated come out of your pocket. Run out of money and the shift is over.',
    ...
    steer:
      'Drag to drive — {fuel} soʻm a block. Tap a word to translate it — {word} soʻm. Tap the taxi to drop off.',
    thanks: 'Rahmat!',
