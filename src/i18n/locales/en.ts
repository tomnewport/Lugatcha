...
export default {
  ...
  bubbles: {
    ...
    steer: 'Drag left and right to move',
    fire: 'Fire',
  ...
  taxi: {
    ...
    level: 'Level {level}',
    howTo:
      'Your passenger gives directions in Uzbek. Drag the taxi along the streets to where they mean, then tap it to let them out — turn where you were told, and pull up in the street they named. Stop on the wrong corner and they will tell you the way from there instead, as often as it takes; it costs nothing but the driving. The fare is worth a word each plus its distance, and that is the purse: fuel and every word you tap to have translated come out of it, and you keep what is left when they step out. Spend the lot and it costs one of your three fares.',
    start: 'Start the shift',
    takings: 'Takings',
    fare: 'Fare',
    best: 'Best',
    livesLeft: '{count} fares left to write off',
    bust: 'The fare is spent — that is a life.',
    thousands: '{amount}k soʻm',
    mapAria: 'City map — drag the taxi along the streets to drive it',
    hearAgain: 'Hear the directions again',
    buyWord: 'Buy the meaning of {word} for {price} soʻm',
    sayWord: 'Say {word} again',
    dropOff: 'Drop off here',
    nextFare: 'Next passenger',
    steer:
      'Drag to drive — {fuel} soʻm a block, out of the fare. Tap a word to translate it — {word} soʻm. Tap the taxi to drop off; on the wrong corner they will direct you again.',
    arrived: 'Rahmat!',
    notThere: 'Not here — they stay in the cab.',
    redirected: 'Not here — from here, they say:',
    broke: 'You spent the whole fare getting there.',
    paid: '+{amount} soʻm',
    over: 'End of shift',
    finalScore: 'Best takings {takings} soʻm, over {count} fares.',
    newBest: 'New best!',
    again: 'Drive again',
    done: 'Done',
    skip: 'Close the game',
    ...
    word: {
      ...
      ordinal3: 'third',
      ordinal4: 'fourth',
      street: 'street (koʻcha + -dan)',
      streetTo: 'into the street (koʻcha + -ga)',
      crossroads: 'crossroads (chorraha + -dan)',
      turning: 'turning (burilish + -dan)',
      left: 'to the left',
      right: 'to the right',
      leftPlain: 'left',
      rightPlain: 'right',
      leftOn: 'the one on the left',
      rightOn: 'the one on the right',
      towards: 'towards (tomon + -ga)',
      turn: 'turn (polite)',
      turnAlt: 'turn (polite)',
      then: 'then',
      straightOn: 'straight on',
      straightPlain: 'straight',
      one: 'one',
      two: 'two',
      three: 'three',
      four: 'four',
      ...
      taOne: 'one (bir + -ta)',
      taTwo: 'two (ikki + -ta)',
      taThree: 'three (uch + -ta)',
      taFour: 'four (toʻrt + -ta)',
      taFive: 'five (besh + -ta)',
      block: 'block',
      go: 'go, drive (polite)',
      goBor: 'go (polite)',
      drive: 'drive (polite)',
      beside: 'from beside it (yon + -idan)',
      whenReached: 'when you reach it',
      placeBare: 'the {place}',
      atPlace: 'at the {place} (-da)',
      toPlace: 'to the {place} (-ga)',
      asFarAsPlace: 'as far as the {place} (-gacha)',
    },
  },
  ...
  settings: {
    ...
    game: {
      ...
      bestTaxi: 'Taxi driver — best takings: {score} soʻm',
    },
